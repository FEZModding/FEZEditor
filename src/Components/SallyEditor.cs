...
public class SallyEditor : EditorComponent
{
    ...
    private void DrawProperties()
    {
        ...
        var maps = new Dirty<List<string>>(_saveData.Maps);
        ...
        var artifacts = new Dirty<List<ActorType>>(_saveData.Artifacts);
        ...
        var earnedAchievements = new Dirty<List<string>>(_saveData.EarnedAchievements);
        ...
        var earnedGamerPictures = new Dirty<List<string>>(_saveData.EarnedGamerPictures);
    ...
    private void DrawLevelProperties()
    {
        ...
        var destroyedTriles = new Dirty<List<TrileEmplacement>>(levelData.DestroyedTriles);
        ...
        var inactiveTriles = new Dirty<List<TrileEmplacement>>(levelData.InactiveTriles);
        ...
        var inactiveArtObjects = new Dirty<List<int>>(levelData.InactiveArtObjects);
        ...
        var inactiveEvents = new Dirty<List<int>>(levelData.InactiveEvents);
        ...
        var inactiveGroups = new Dirty<List<int>>(levelData.InactiveGroups);
        ...
        var inactiveVolumes = new Dirty<List<int>>(levelData.InactiveVolumes);
        ...
        var inactiveNpcs = new Dirty<List<int>>(levelData.InactiveNPCs);
        ...
        var pivotRotations = new Dirty<Dictionary<int, int>>(levelData.PivotRotations);
        ...
        var scriptIds = new Dirty<List<int>>(winConditions.ScriptIds);
