...
internal sealed class TrileContext : BaseContext
{
    ...
    public override void DrawProperties()
    {
        ...
        if (instance.ActorSettings != null)
        {
            ...
            if (ImGuiX.EditableArray("Sequence", ref sequence, RenderItem, () => default))
            {
    ...
    private void DrawMultiProperties()
    {
        ...
        if (ImGuiX.DragFloat3("Position", ref positionDrag, 0.1f))
        {
            ...
            {
                foreach (var emp in _selectedCursor.Emplacements.Where(e =>
    ...
    private void ApplyActiveInstance(TrileEmplacement emplacement, TrileInstance active)
    {
        ...
        else
        {
            ...
            {
                var mesh = actor.GetComponent<TrilesMesh>();
                mesh.SetOverlapInstanceData(emplacement, slot, active.Position.ToXna(), active.PhiLight,
                    ActiveLayerTint(slot));
            }
        }
    }
